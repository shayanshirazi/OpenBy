      ...
      <div className="relative mx-auto max-w-6xl px-6">
        ...
        <div className="mb-10 flex flex-col items-start gap-4 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            >
              {(score / 10).toFixed(1)}
              <span className="text-[0.55em] font-normal opacity-90 [vertical-align:-0.4em]">/10</span>
            </span>
          </div>
        </div>
          ...
          <div className="mb-10 rounded-xl border border-zinc-200/80 bg-white/80 p-4 shadow-sm">
            ...
            <div className="flex items-center gap-4">
              ...
              <span className="text-sm font-semibold text-zinc-700">
                ...
                <span className="text-[0.65em] font-normal text-zinc-500 [vertical-align:-0.4em]">/10</span>
              </span>
            </div>
          </div>
        )}
